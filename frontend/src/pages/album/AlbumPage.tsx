                ...
                <div className="relative min-h-full">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="px-6 pb-4 flex items-center gap-6">
                            ...
                            size="icon" className="size-14 flex items-center justify-center rounded-full bg-green-500 hover:bg-green-400 hover:scale-110 transition-all duration-500 ease-in-out"
                            >
                                        ...
                                        return (
                                            <div key={song._id}
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <img src={song.imageUrl} className="size-10 rounded-sm" alt={song.title} />
