    ...
    return (
        <div className="border-r border-zinc-800">
            <div className="flex flex-col h-full">
                <ScrollArea className="h-[100vh-180px]">
                                ...
                                <div key={user._id} onClick={() => setSelectedUser(user)}
                                    className={`flex items-center justify-center lg:justify-start gap-3 p-3
                                        ...
                                        <div className="relative">
                                            ...
                                            {/* online indicator */}
                                            <div className={`absolute bottom-0 right-0 size-3 rounded-full ring-2 ring-zinc-900 ${onlineUsers.has(user.clerkId) ? "bg-green-500"
                                             : "bg-zinc-500"}`} />
                                        </div>
